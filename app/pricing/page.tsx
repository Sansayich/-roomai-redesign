            ...
            {[
              {
                ...
                a: 'Каждая генерация изображения стоит 2 кредита за выбранный стиль. Вы получаете 4 бесплатных кредита при регистрации - хватит на 2 генерации!'
              },
              {
              ...
              {
                q: 'Какое качество генерации?',
                a: 'Мы используем только высококачественную генерацию за 2 кредита за стиль. Наша система использует продвинутые алгоритмы ИИ, которые сохраняют геометрию комнаты, расположение окон и дверей, обеспечивая точное соответствие оригинальному изображению.'
              },
              {
